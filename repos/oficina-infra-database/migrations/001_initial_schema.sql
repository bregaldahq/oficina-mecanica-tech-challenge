...
-- Schema inicial da Oficina Mecânica (7 tabelas).
--
-- Sem CREATE DATABASE e sem USE: o database é criado pelo RDS
-- (aws_db_instance.db_name) e a conexão do runner já chega apontada
-- para ele. Todo o arquivo é idempotente (CREATE TABLE IF NOT EXISTS).
-- ============================================================
